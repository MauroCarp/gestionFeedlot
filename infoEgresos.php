<div class="row-fluid">
  ...
  <div class="span12">
    ...
    <ul class="totales">
        ...
        <li><b>- Kg Neto Engreso: </b><?php echo number_format($pesoTotalEgr,2,",",".")." Kg";?></li>

        <li><b>- Kg Egreso Promedio: </b><?php echo number_format($kgEgrProm,2,",",".")." Kg";?></li>

        <li><b>- Peso Min. Promedio: </b><?php echo number_format($kgMinEgr,0,",",".")." Kg";?></li>

        <li><b>- Peso Max. Promedio: </b><?php echo number_format($kgMaxEgr,0,",",".")." Kg";?></li>
