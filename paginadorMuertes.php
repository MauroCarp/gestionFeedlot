...
$sqlQuery = "SELECT * FROM muertes WHERE feedlot = '$feedlot' ORDER BY fecha DESC LIMIT 8 OFFSET $desde";
...
<td style="text-align:left;"><?php echo $fila['origen'];?></td>
  
  <td style="text-align:left;"><?php echo $fila['proveedor'];?></td>
